...
class ControllerExtensionModuleMegaFilter extends Controller {
	...
	private function _init( $tab ) {
		...
		// linki zakładek
		$this->data['tab_layout_link']		= $this->url->link('extension/module/' . $this->_name, 'token=' . $this->session->data['token'], 'SSL');
		$this->data['tab_attributes_link']	= $this->url->link('extension/module/' . $this->_name . '/attributes', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['tab_options_link']		= $this->url->link('extension/module/' . $this->_name . '/options', 'token=' . $this->session->data['token'], 'SSL');
		if( $this->hasFilters() ) {
			$this->data['tab_filters_link']		= $this->url->link('extension/module/' . $this->_name . '/filters', 'token=' . $this->session->data['token'], 'SSL');
		}
		$this->data['tab_settings_link']	= $this->url->link('extension/module/' . $this->_name . '/settings', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['tab_seo_link']	= $this->url->link('extension/module/' . $this->_name . '/seo', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['tab_about_link']		= $this->url->link('extension/module/' . $this->_name . '/about', 'token=' . $this->session->data['token'], 'SSL');
		
		// linki
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name, 'token=' . $this->session->data['token'], 'SSL');
		$this->data['back']		= $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/' . $this->_name, 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		...
		if( ! $curr_ver || version_compare( $curr_ver, $this->_version, '<' ) || $this->_isOldMFilterPlus() ) {			
			...
			if( $curr_ver ) {
				...
				$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/about', 'token=' . $this->session->data['token'], 'SSL'));
			}
		} else if( ! file_exists( DIR_SYSTEM . '../catalog/view/theme/default/template/extension/module/mega_filter.tpl' ) ) {
		...
		if( is_readable( __FILE__ ) ) {
			...
			$files = glob( DIR_SYSTEM . '../catalog/view/theme/*/template/extension/module/mega_filter.tpl' );
			$source = filemtime( DIR_SYSTEM . '../catalog/view/theme/default/template/extension/module/mega_filter.tpl' );
			...
			foreach( $files as $id => $file ) {
				...
				if( $theme == 'default' || ! is_readable( $file ) ) {
					...
					if( $source - $time > 60 * 10 ) {
						$files[$id] = '<span style="margin-left:15px; display: inline-block;"> - /catalog/view/theme/<b>' . $theme . '</b>/template/extension/module/mega_filter.tpl</span>';
					} else {
						unset( $files[$id] );
					}
				}
		...
		if( class_exists( 'MijoShop' ) && version_compare( $this->config->get('mfilter_mijoshop'), $curr_ver, '<' ) ) {
			...
			if( empty( $warnings ) ) {
				...
				$warnings[] = sprintf( 'Remember to make backup your files! <a href="%s">Click here when you done</a>', $this->url->link('extension/module/' . $this->_name . '/mijoshop_manually', 'token=' . $this->session->data['token'], 'SSL') );
	...
	public function mijoshop_manually() {
		...
		$this->response->redirect($this->url->link('extension/module/' . $this->_name, 'token=' . $this->session->data['token'], 'SSL'));
	}
	...
	public function index() {
		...
		$this->data['action_ldv']			= $this->url->link('extension/module/' . $this->_name . '/ldv', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_save_data']		= $this->url->link('extension/module/' . $this->_name . '/save_data', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_get_data']		= $this->url->link('extension/module/' . $this->_name . '/get_data', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_remove_data']	= $this->url->link('extension/module/' . $this->_name . '/remove_data', 'token=' . $this->session->data['token'], 'SSL');
				
		$this->response->setOutput( $this->load->view('extension/module/mega_filter.tpl', $this->data) );
	}
	...
	public function ldv() {
		...
		$pagination->url = $this->url->link('extension/module/mega_filter/ldv', 'token=' . $this->session->data['token'] . '&page={page}', 'SSL');
			
		$this->data['pagination'] = $pagination->render();
		
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_ldv.tpl', $this->data) );
	}
	...
	public function attributes() {
		...
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name . '/attributes', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL');
		...
		if( $this->request->server['REQUEST_METHOD'] == 'POST' && $this->checkPermission() ) {
			...
			$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/attributes', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL'));
		}
		...
		$this->data['action_attribs_by_group'] = $this->url->link('extension/module/' . $this->_name . '/getAttribsByGroupAsJson', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_values_by_attrib'] = $this->url->link('extension/module/' . $this->_name . '/getAttribsValuesByAttribAsJson', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_attribs_save'] = $this->url->link('extension/module/' . $this->_name . '/attribsSave', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_attribs_reset'] = $this->url->link('extension/module/' . $this->_name . '/attribsReset', 'token=' . $this->session->data['token'], 'SSL');
		...
		$pagination->limit = $limit;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/module/mega_filter/attributes', 'token=' . $this->session->data['token'] . '&page={page}', 'SSL');
			
		$this->data['pagination'] = $pagination->render();
		
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_attributes.tpl', $this->data) );
	}
	...
	public function options() {
		...
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name . '/options', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL');
		...
		if( $this->request->server['REQUEST_METHOD'] == 'POST' && $this->checkPermission() ) {
			...
			$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/options', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL'));
		}
		...
		$pagination->limit = $limit;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/module/mega_filter/options', 'token=' . $this->session->data['token'] . '&page={page}', 'SSL');
			
		$this->data['pagination'] = $pagination->render();
		
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_options.tpl', $this->data) );
	}
	...
	public function filters() {
		...
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name . '/filters', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL');
		...
		if( $this->request->server['REQUEST_METHOD'] == 'POST' && $this->checkPermission() ) {
			...
			$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/filters', 'token=' . $this->session->data['token'] . '&page=' . $page, 'SSL'));
		}
		...
		$this->data['action_filters_save'] = $this->url->link('extension/module/' . $this->_name . '/filtersSave', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_filters_reset'] = $this->url->link('extension/module/' . $this->_name . '/filtersReset', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_values_by_filter'] = $this->url->link('extension/module/' . $this->_name . '/getFiltersValuesByFilterAsJson', 'token=' . $this->session->data['token'], 'SSL');
		...
		$pagination->limit = $limit;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/module/mega_filter/filters', 'token=' . $this->session->data['token'] . '&page={page}', 'SSL');
			
		$this->data['pagination'] = $pagination->render();
		
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_filters.tpl', $this->data) );
	}
	...
	public function settings() {
		...
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name . '/settings', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['action_clear_cache']	= $this->url->link('extension/module/' . $this->_name . '/clearcache', 'token=' . $this->session->data['token'], 'SSL');
		...
		if( $this->request->server['REQUEST_METHOD'] == 'POST' && $this->checkPermission() ) {
			...
			if( $this->_hasMFilterPlus() ) {
				...
				if( $before != $after ) {
					$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/installprogress', 'token=' . $this->session->data['token'], 'SSL'));
				}
			}
						
			$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/settings', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_settings.tpl', $this->data) );
	}
	...
	public function seo() {
		...
		$this->data['action'] = $this->url->link('extension/module/' . $this->_name . '/seo', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['aliases_url'] = $this->url->link('extension/module/' . $this->_name . '/aliases', 'token=' . $this->session->data['token'], 'SSL');
		...
		if( $this->request->server['REQUEST_METHOD'] == 'POST' && $this->checkPermission() ) {
			...
			$this->response->redirect($this->url->link('extension/module/' . $this->_name . '/seo', 'token=' . $this->session->data['token'], 'SSL'));
		}
				
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_seo.tpl', $this->data) );
	}
	...
	public function aliases() {
		...
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_aliases.tpl', $this->data) );
	}
	...
	public function clearcache() {
		...
		$this->response->redirect($this->url->link('extension/module/mega_filter/settings', 'token=' . $this->session->data['token'], 'SSL'));
	}
	...
	public function about() {
		...
		$this->data['action']	= $this->url->link('extension/module/' . $this->_name . '/about', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_about.tpl', $this->data) );
	}
	...
	public function installprogress() {
		...
		$this->data['progress_action'] = $this->url->link('extension/module/' . $this->_name.'/installprogress', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['main_action'] = $this->url->link('extension/module/' . $this->_name, 'token=' . $this->session->data['token'], 'SSL');
		
		$this->response->setOutput( $this->load->view('extension/module/mega_filter_installprogress.tpl', $this->data) );
	}
