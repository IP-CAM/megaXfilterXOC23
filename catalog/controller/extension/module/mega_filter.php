...
class ControllerExtensionModuleMegaFilter extends Controller {
	...
	public function index( $setting ) {		
		...
		$data['ajaxInfoUrl']		= $this->parseUrl( $this->url->link( 'extension/module/mega_filter/ajaxinfo', '', 'SSL' ) );
		$data['ajaxResultsUrl']		= $this->parseUrl( $this->url->link( 'extension/module/mega_filter/results', '', 'SSL' ) );
		$data['ajaxCategoryUrl']	= $this->parseUrl( $this->url->link( 'extension/module/mega_filter/categories', '', 'SSL' ) );
		...
		$data['getSymbolLeft']	= $this->currency->getSymbolLeft($this->session->data['currency']);
		$data['getSymbolRight']	= $this->currency->getSymbolRight($this->session->data['currency']);
		 ...
		 * Szablon 
		 */
		if( file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/extension/module/mega_filter.tpl') ) {
			return $this->load->view($this->config->get('config_template') . ' /extension/module/mega_filter.tpl', $data);
		} else {
			return $this->load->view('/extension/module/mega_filter.tpl', $data);
		}
	}
